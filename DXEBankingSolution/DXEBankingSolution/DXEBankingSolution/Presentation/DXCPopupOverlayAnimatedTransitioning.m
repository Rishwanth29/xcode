//
//  DXCPopupOverlayTransitioningDelegate.m
//
...
@implementation DXCPopupOverlayTransitioningDelegate
...
- (UIPresentationController *)presentationControllerForPresentedViewController:(UIViewController *)presented presentingViewController:(UIViewController *)presenting sourceViewController:(UIViewController *)source
{
    ...
    Class presentationControllerClass;
        presentationControllerClass = [DXCPopupOverlayPresentationController class];
    
    
    return [[presentationControllerClass alloc] initWithPresentedViewController:presented presentingViewController:presenting];
}

- (DXCPopupOverlayAnimatedTransitioning *)animationController
{
    DXCPopupOverlayAnimatedTransitioning *animationController = [[DXCPopupOverlayAnimatedTransitioning alloc] init];
    return animationController;
}

- (id <UIViewControllerAnimatedTransitioning>)animationControllerForPresentedController:(UIViewController *)presented presentingController:(UIViewController *)presenting sourceController:(UIViewController *)source
{
    DXCPopupOverlayAnimatedTransitioning *animationController = [self animationController];
...
@implementation DXCPopupOverlayAnimatedTransitioning
